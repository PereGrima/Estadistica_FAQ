# ¿Cuántos elementos debe tener una muestra para que las conclusiones sean fiables? {.unnumbered}

En el ámbito del muestreo probabilístico, el tamaño de muestra se calcula aplicando una fórmula que puede ser más o menos complicada dependiendo del tipo de muestreo. En el caso del muestreo aleatorio simple y para la estimación de una proporción, $p$, tenemos:
$$ n = \frac{Np(1-p)}{(N-1)(E^2/z^2)+p(1-p)} $$
...
Parece que esta es la variable cuya influencia está más justificada, pero no es así. Si la población es grande --y esto es lo más habitual-- su tamaño prácticamente no influye. Usando la fórmula que hemos visto y con la ayuda de una hoja de cálculo se puede construir la tabla \normalfont{\ref{TamañosMuestra}} donde se aprecia la poca influencia del tamaño de la población.

<table style="border-collapse:collapse; width:90%; font-size:0.85em; text-align:center; margin-bottom:2em;">
<style>
