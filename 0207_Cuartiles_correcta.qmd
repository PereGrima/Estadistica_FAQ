...
$\bullet \;$ Datos: 2, 4, 6, 8, 10 <br>
Posición de $Q_1$: $\;0.25 \cdot 6 = 1.5$; $\;$ Valor de $Q_1$: $\; 2  +0.5(4-2) = 3$ <br>
Posición de $Q_3$: $\;0.75 \cdot 6 = 4.5); $\;$ Valor de $Q_3$: $\; 8 + 0.5(10-8) = 9$

$\bullet \;$ Datos: 2, 4, 6, 8 <br>
Posición $Q_1$: $\;0.25 \cdot 5 = 1.25)$; $\;$ Valor $Q_1$: $\; 2 + 0.25(4-2) = 2.5)$ <br>
Posición $Q_3$: $\;0.75 \cdot 5 = 3.75)$; $\;$ Valor $Q_3$: $\; 6 + 0.75(8-6) = 7.5)$
...
<!--         <TD style="vertical-align: middle"> Método</TD> -->
<!--         <TD ALIGN=center COLSPAN=2 >&nbsp &nbsp Datos: 2, 4, 6, 8 &nbsp &nbsp &nbsp &nbsp <br> Q <sub> 1 </sub> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Q<sub> 3 </sub> </TD> -->
<!--         <TD ALIGN=center COLSPAN=2>Datos: 2, 4, 6, 8, 10 <br> Q<sub> 1 </sub> &nbsp &nbsp &nbsp &nbsp &nbsp Q<sub> 3 </sub></TD> -->
<!--     </TR> -->

<!--     <TR >    -->
<!--     <TD>Tukey <br> Moore y McCabe <br> Minitab <br> Excel, CUARTIL.INC <br> Excel, CUARTIL.INC </TD>  -->
<!--     <TD ALIGN=center> 3 <br> 3 <br> 2.5 <br> 3.5 <br> 2.5 </TD>  -->
<!--     <TD ALIGN=center> 7 <br> 7 <br> 7.5 <br> 6.5 <br> 7.5 </TD>    -->
<!--     <TD ALIGN=center> 4 <br> 3 <br> 3 <br> 4 <br> 3 </TD>  -->
<!--     <TD ALIGN=center> 8 <br> 9 <br> 9 <br> 8 <br> 9 </TD> -->
<!--     </TR> -->
<!-- </table> -->
<!-- </h8>  -->
<!-- ``` -->
...
<h6>
<table width="500" cellpadding="1" class="center" style="margin: 0 auto;">
<td colspan="100%"></td>
    <tr>
        <TD style="vertical-align: middle"> Método</TD>
        <TD ALIGN=center COLSPAN=2 > Datos: 2, 4, 6, 8  <br> Q <sub> 1 </sub> </sub> &nbsp &nbsp &nbsp &nbsp &nbsp Q<sub> 3 </sub> </TD>
        <TD ALIGN=center COLSPAN=2>Datos: 2, 4, 6, 8, 10 <br> Q<sub> 1 </sub> </sub> &nbsp &nbsp &nbsp &nbsp &nbsp Q<sub> 3 </sub></TD>
        <hr>
    </TR>
    ...
    <TD ALIGN=center> 3 <br> 3 <br> 2.5 <br> 3.5 <br> 2.5 </TD> 
    <TD ALIGN=center> 7 <br> 7 <br> 7.5 <br> 6.5 <br> 7.5 </TD> 
    <TD ALIGN=center> &nbsp &nbsp &nbsp  4 <br> &nbsp 3 <br> &nbsp 3 <br> &nbsp 4 <br> &nbsp 3  </TD> 
    <TD ALIGN=center> 8 &nbsp &nbsp &nbsp <br> 9 <br> 9 <br> 8 <br> 9 </TD>
    </TR>
</table>
</h6> 
```
