# 2.7 ¿Cuál es la forma correcta de calcular los cuartiles? {#cuartiles .unnumbered}
...
<colgroup>
  ...
  <thead>
     <tr>
        <th rowspan=2 style="vertical-align: middle;" ALIGN=left> Método </th>
        <th colspan=2> &nbsp Datos: 2, 4, 6, 8 </th>
        <th colspan=2> Datos: 2, 4, 6, 8, 10 </th>
    </tr>
    <tr>
        <th> &nbsp &nbsp Q<sub>1</sub> </th>
        <th> Q<sub>3</sub> &nbsp &nbsp </th>
        <th> &nbsp &nbsp Q<sub>1</sub> </th>
        <th> Q<sub>3</sub> &nbsp &nbsp </th>
    </tr>
   </thead>
    ...
    <tr>
    <TD ALIGN=left>Tukey <br> Moore y McCabe <br> Minitab <br> Excel, CUARTIL.INC <br> Excel, CUARTIL.EXC </TD>
