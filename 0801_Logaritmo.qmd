# 8.1 Cuándo se habla de transformación logarítmica, ¿se refiere al logaritmo decimal o al neperiano? {.unnumbered #logaritmo}
...
\noindent Como $x$ es el nombre que hemos dado a $\ln(y)$, el $\ln(10)$ es una constante igual a 2,3026 y $z$ es el nombre asignado a $\log_{10}(y)$, tenemos: $$\ln(y)=z\ln(10)=2,3026z=2,3026\log_{10}(y)$$
